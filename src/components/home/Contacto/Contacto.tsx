  ...
  return (
    <section id="contactos" className="py-24 bg-zinc-950">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="mb-4">Cotizá tu barra al instante</h2>
        <p className="text-gray-400 mb-10 max-w-xl mx-auto">
          Completá el formulario o escribinos directamente por WhatsApp. Te respondemos con una propuesta personalizada para tu evento.
        </p>
